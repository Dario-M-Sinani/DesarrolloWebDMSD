...
$id=$_GET['id'];
$sql="SELECT id,fotografia,nombres,apellidos,carnet,sexo,fecha_nacimiento,direccion,mesa_id FROM padron WHERE id=$id";
...
<form action="update.php" method="post">
    <img src="images/<?php echo $fila['fotografia']?>" ><br>
